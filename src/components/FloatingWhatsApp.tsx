...
export const FloatingWhatsApp: React.FC = () => {
  ...
  return (
    <div className={`fixed bottom-20 sm:bottom-6 ${isRTL ? 'left-4 sm:left-6 items-start' : 'right-4 sm:right-6 items-end'} z-40 flex flex-col`}>
      {/* Tooltip bubble */}
      {showTooltip && (
        <div className="mb-2 sm:mb-3 p-2.5 sm:p-3 bg-white rounded-2xl shadow-xl border border-slate-200 text-xs text-slate-700 max-w-[200px] sm:max-w-[220px] relative animate-in fade-in slide-in-from-bottom-2 duration-300">
          <button
      ...
      <a
        ...
        className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-emerald-500 hover:bg-emerald-600 active:bg-emerald-700 text-white flex items-center justify-center shadow-lg shadow-emerald-500/30 hover:scale-105 active:scale-95 transition-all duration-200 group relative cursor-pointer"
